  ...
  Widget build(BuildContext context) {
    Widget makeTile(String text, [IconData? icon]) {
      return icon == null
          ...
          : ListTile(
              leading: icon == null ? const SizedBox() : Icon(icon),
              title: Text(text),
              contentPadding: EdgeInsets.all(15),
              tileColor: Colors.black12,
              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
    ...
    return Scaffold(
      ...
      body: ListView(padding: EdgeInsets.all(35), children: <Widget>[
        Align(
          alignment: FractionalOffset(0.5, 0.5),
          child: CircleAvatar(
            backgroundImage: AssetImage('assets/cartoon.jpeg'),
            radius: 50,
            child: Align(
